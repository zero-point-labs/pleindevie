...
export const LeadCaptureForm: React.FC<LeadCaptureFormProps> = ({ 
  ...
  return (
    <section 
      ref={formRef}
      id="contact"
      className={cn("relative py-12 lg:py-20 overflow-hidden bg-gradient-to-br from-slate-50 via-white to-orange-50", className)}
    >
      {/* Background Pattern */}
      <GridPattern
        squares={[
        ...
        <BlurFade delay={0.1}>
          <div className="text-center mb-16 lg:mb-20">
            <motion.div
              ...
              className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-amber-50 to-yellow-50 border border-amber-200 rounded-full mb-6"
            >
                  ...
                  {[
                    ...
                    <BlurFade key={index} delay={0.4 + index * 0.1}>
                      <motion.div
                        ...
                        className={cn(
                          "flex items-center p-4 rounded-xl transition-all duration-300 cursor-pointer group",
                          benefit.highlight 
                      ...
                      >
                        <span className="text-2xl mr-4 group-hover:scale-110 transition-transform duration-300">{benefit.icon}</span>
                        <span className={cn(
              ...
              >
                <div className="p-6 relative">
                  <div className="flex items-center mb-3">
                    ...
                    <span className="font-bold text-orange-600 text-sm uppercase tracking-wide">Limited Time Offer</span>
                  </div>
                  <p className="text-gray-900 font-semibold text-lg">
                    Book this month and save <span className="text-orange-600 font-bold">15%</span> on your project
                  </p>
                  <p className="text-gray-600 text-sm mt-2">Plus free design consultation worth $500</p>
                </div>
              </NeonGradientCard>
            </BlurFade>
          </div>
                ...
                >
                  ...
                  <div className="p-6 md:p-8 lg:p-10">
                      ...
                      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                <FormLabel className="text-gray-700 font-semibold text-sm uppercase tracking-wide">Full Name *</FormLabel>
                                <FormControl>
                                  <div className="relative group">
                                    <Input
                                      placeholder="Enter your full name"
                                      className="bg-white/90 backdrop-blur border-gray-300 text-gray-900 placeholder:text-gray-500 focus:border-amber-500 focus:ring-amber-500/20 h-12 transition-all duration-300 group-hover:bg-white"
                                      {...field}
                                    />
                                  </div>
                                </FormControl>
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                <FormLabel className="text-gray-700 font-semibold text-sm uppercase tracking-wide">Email Address *</FormLabel>
                                <FormControl>
                                  <div className="relative group">
                                    <Input
                                      type="email"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                <FormLabel className="text-gray-700 font-semibold text-sm uppercase tracking-wide">Phone Number *</FormLabel>
                                <FormControl>
                                  <div className="relative group">
                                    <Input
                                      type="tel"
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                <FormLabel className="text-gray-700 font-semibold text-sm uppercase tracking-wide">Project Type *</FormLabel>
                                <FormControl>
                                  <div className="relative group">
                                    <Select
                                      className="bg-white/90 backdrop-blur border-gray-300 text-gray-900 focus:border-amber-500 focus:ring-amber-500/20 h-12 transition-all duration-300 group-hover:bg-white"
                                      {...field}
                                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                <FormLabel className="text-gray-700 font-semibold text-sm uppercase tracking-wide">Budget Range *</FormLabel>
                                <FormControl>
                                  <div className="relative group">
                                    <Select
                                      className="bg-white/90 backdrop-blur border-gray-300 text-gray-900 focus:border-amber-500 focus:ring-amber-500/20 h-12 transition-all duration-300 group-hover:bg-white"
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                <FormLabel className="text-gray-700 font-semibold text-sm uppercase tracking-wide">Timeline *</FormLabel>
                                <FormControl>
                                  <div className="relative group">
                                    <Select
                                      className="bg-white/90 backdrop-blur border-gray-300 text-gray-900 focus:border-amber-500 focus:ring-amber-500/20 h-12 transition-all duration-300 group-hover:bg-white"
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-gray-700 font-semibold text-sm uppercase tracking-wide">Additional Details</FormLabel>
                              <FormControl>
                                <div className="relative group">
                                  <Textarea
                                    placeholder="Tell us more about your project..."
                                    className="bg-white/90 backdrop-blur border-gray-300 text-gray-900 placeholder:text-gray-500 focus:border-amber-500 focus:ring-amber-500/20 min-h-[120px] resize-none transition-all duration-300 group-hover:bg-white"
                                    {...field}
                                  />
                                </div>
                              </FormControl>
                        ...
                        <div className="pt-6">
                          <ShimmerButton
                            ...
                            className="w-full py-4 text-lg font-bold text-white relative overflow-hidden"
                            shimmerSize="0.1em"
                            shimmerDuration="2s"
                    ...
                    <motion.p 
                      ...
                      className="text-xs text-gray-500 text-center leading-relaxed mt-6 flex items-center justify-center"
                    >
